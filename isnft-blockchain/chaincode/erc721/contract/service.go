...
func (c *ERC721Contract) BalanceOf(ctx contractapi.TransactionContextInterface, owner string) int {
...
func (c *ERC721Contract) OwnerOf(ctx contractapi.TransactionContextInterface, tokenId string) (string, error) {
...
func (c *ERC721Contract) Approve(ctx contractapi.TransactionContextInterface, operator string, tokenId string) (bool, error) {
...
// returns {Boolean} Return whether the approval was successful or not
func (c *ERC721Contract) SetApprovalForAll(ctx contractapi.TransactionContextInterface, operator string, approved bool) (bool, error) {
...
func (c *ERC721Contract) IsApprovedForAll(ctx contractapi.TransactionContextInterface, owner string, operator string) (bool, error) {
...
func (c *ERC721Contract) GetApproved(ctx contractapi.TransactionContextInterface, tokenId string) (string, error) {
...
func (c *ERC721Contract) TransferFrom(ctx contractapi.TransactionContextInterface, from string, to string, tokenId string) (bool, error) {
...
func (c *ERC721Contract) Name(ctx contractapi.TransactionContextInterface) (string, error) {
...
func (c *ERC721Contract) Symbol(ctx contractapi.TransactionContextInterface) (string, error) {
...
func (c *ERC721Contract) TokenURI(ctx contractapi.TransactionContextInterface, tokenId string) (string, error) {
...
func (c *ERC721Contract) TotalSupply(ctx contractapi.TransactionContextInterface) int {
...
func (c *ERC721Contract) Initialize(ctx contractapi.TransactionContextInterface, name string, symbol string) (bool, error) {
...
func (c *ERC721Contract) Burn(ctx contractapi.TransactionContextInterface, tokenId string) (bool, error) {
...
func (c *ERC721Contract) ClientAccountBalance(ctx contractapi.TransactionContextInterface) (int, error) {
...
func (c *ERC721Contract) ClientAccountID(ctx contractapi.TransactionContextInterface) (string, error) {
